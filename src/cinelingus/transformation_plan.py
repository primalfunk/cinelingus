...
TRANSLATION_LIFECYCLE = [VERB_SELECT, "TRANSFORM", "VALIDATE", VERB_PLACE, VERB_RENDER, VERB_REPORT]
...
def build_translation_plan(
    *,
    ...
    output_video = output_dir / "translation_output.mp4"
    ...
    return {
        ...
        "transformation": {
            ...
            "description": "Transfer spoken performances from a donor film into an anchor-film montage.",
            "lifecycle": TRANSLATION_LIFECYCLE,
        },
        "inputs": {
            "destination_video": {
...
# Canonical public name; retained old symbol supports existing integrations.
build_translation_plan = build_translation_plan
