...
def save_recipe_dialog(app: Any) -> None:
    try:
        ...
        recipe = FilterRecipe.create(
            ...
            output_settings={"form": "best_short" if app.workflow_var.get() == "Best Short Remix" else "full_length", "output_directory": str(config.output_dir)},
...
def load_recipe_dialog(app: Any) -> None:
    ...
    app.workflow_var.set("Full Movie Remix" if loaded.recipe.output_settings.get("form") == "full_length" else "Best Short Remix")
