...
from movie_masher.util import read_json
from movie_masher.validation import ValidationError, validate_artifact
...
def _validate_contract_against_definition(contract: FilterContract, definition: FilterDefinition) -> None:
    ...
    capability_expectations = {
        ...
        "supports_best_short": "best_short" in definition.supported_output_forms,
