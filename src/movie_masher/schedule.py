...
from .transformation_verbs import movie_masher_transformation_plan, select_dialogue_clips, select_speaking_windows
...
def build_schedule(
    *,
    ...
    transformation_name: str = "movie_masher",
    ...
    data = {
        ...
        "transformation_history": transformation_history or movie_masher_transformation_plan(),
