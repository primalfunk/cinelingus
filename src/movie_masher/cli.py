...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="movie-masher")
    ...
    parser.add_argument("--quick", type=float, default=None, metavar="SECONDS", help="Transcribe only the first N seconds for quick testing.")
    ...
    preset.add_argument("preset_id", help="Preset id to run, for example movie_masher or self_shuffle.")
